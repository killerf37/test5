...
import com.ginfon.core.exception.FileNameLengthLimitExceededException;
import com.ginfon.core.web.config.CommonConfig;
...
public class FileUploadUtils {
	 ...
	 * 默认上传的地址
	 */
	private static String defaultBaseDir = CommonConfig.getUpload();
