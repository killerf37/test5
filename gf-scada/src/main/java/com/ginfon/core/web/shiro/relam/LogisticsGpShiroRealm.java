package com.ginfon.core.web.shiro.relam;

import com.ginfon.core.exception.*;
 ...
 * @author James
 */
public class LogisticsGpShiroRealm extends AuthorizingRealm {
	private static final Logger log = LoggerFactory.getLogger(LogisticsGpShiroRealm.class);
