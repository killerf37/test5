...
import com.ginfon.core.web.mapper.PostMapper;
import com.ginfon.core.web.mapper.UserPostMapper;
...
/**
 * @Author: James
 * @Date: 2019/8/15 23:41
 * @Description:
 */
@Service("postService")
public class PostServiceImpl extends GenericServiceImpl<Post, Long, Query> implements IPostService {
	@Autowired
	...
	@Override
	protected GenericMapper<Post, Long, Query> getDao() {
		return postMapper;
	}
