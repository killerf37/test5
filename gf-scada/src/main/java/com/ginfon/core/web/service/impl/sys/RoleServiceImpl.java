...
import com.ginfon.core.web.entity.RoleMenu;
import com.ginfon.core.web.mapper.RoleMapper;
import com.ginfon.core.web.mapper.RoleMenuMapper;
import com.ginfon.core.web.mapper.UserRoleMapper;
...
/**
 * @Author: James
 * @Date: 2018/6/20 11:21
 * @Description:
 */
@Service("roleService")
public class RoleServiceImpl extends GenericServiceImpl<Role, Long, Query> implements IRoleService {
	@Override
	protected GenericMapper<Role, Long, Query> getDao() {
		return roleMapper;
	}
