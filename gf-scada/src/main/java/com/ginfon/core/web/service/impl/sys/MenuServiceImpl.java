...
import com.ginfon.core.utils.TreeUtils;
import com.ginfon.core.web.entity.Menu;
import com.ginfon.core.web.entity.Role;
import com.ginfon.core.web.mapper.MenuMapper;
 ...
 */
@Service("menuService")
public class MenuServiceImpl extends GenericServiceImpl<Menu, Long, Query> implements IMenuService {
	...
	public List<Map<String, Object>> getTrees(List<Menu> menuList, boolean isCheck, List<String> roleMenuList,
		...
		for (Menu menu : menuList) {
			...
			deptMap.put("title", MessageUtils.message(menu.getI18nKey()));
			if (isCheck) {
	...
	public String transMenuName(Menu menu, List<String> roleMenuList, boolean permsFlag) {
		...
		sb.append(MessageUtils.message(menu.getI18nKey()));
		if (permsFlag) {
	...
	@Override
	protected GenericMapper<Menu, Long, Query> getDao() {
		return null;
	}
}
