...
public class Menu implements Comparable<Menu> {
	...
	public static Menu parse(String id, String str) {
		...
		String name = null, url = null, perms = null, style = null;
		String[] funcArr = null;
		...
		if (len > 4) {
			funcArr = ArrayUtils.subarray(attrs, 4, len);
		...
		return new Menu(id, name, url, style, perms, functions);
	}

	public Menu(String id, String name, String url, String perms, List<Function> functions) {
		this.id = id;
		String[] seqArr = StringUtils.split(id, '.');
		this.seq = NumberUtils.toInt(seqArr[seqArr.length - 1], Integer.MAX_VALUE);
		if (id.indexOf('.') != -1) {
	...
	public Menu(String id, String name, String url, String style, String perms, List<Function> functions) {
		this.id = id;
		String[] seqArr = StringUtils.split(id, '.');
		this.seq = NumberUtils.toInt(seqArr[seqArr.length - 1], Integer.MAX_VALUE);
		if (id.indexOf('.') != -1) {
